...
import { TERMS_COPY } from "@/copy/terms-copy";
  ...
  return (
    <main className="min-h-screen bg-canvas">
      ...
      <div className="mx-auto w-full max-w-6xl px-5 py-10 sm:px-8 sm:py-14 lg:py-20">
        ...
        <TermsIndex sections={TERMS_COPY.sections} />
        ...
        <div className="lg:grid lg:grid-cols-[14rem_minmax(0,48rem)] lg:items-start lg:gap-14">
          <aside className="sticky top-8 hidden max-h-[calc(100vh-4rem)] overflow-y-auto pr-2 lg:block">
            <TermsIndex sections={TERMS_COPY.sections} desktop />
          </aside>
          ...
          <article className="min-w-0 max-w-3xl">
            ...
            <section
              id={TERMS_COPY.complementary.id}
              className="scroll-mt-8 border-t border-border-subtle pt-10 sm:pt-12"
            >
              <p className="mb-3 text-xs font-semibold uppercase tracking-[0.16em] text-primary">
                Anexo
              </p>
              <h2 className="text-2xl font-semibold tracking-tight text-ink sm:text-3xl">
                {TERMS_COPY.complementary.title}
              </h2>
              <div className="mt-6">
                <TermsMarkdown body={TERMS_COPY.complementary.body} />
              </div>
            </section>
          </article>
        </div>
