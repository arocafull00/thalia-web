...
colors:
  ...
  text-muted: "#2E7A8C"
  text-light: "#9A9A9A"
  accent-light: "rgba(61, 143, 160, 0.08)"
  accent-medium: "rgba(61, 143, 160, 0.15)"
  border: "rgba(61, 143, 160, 0.2)"
  card-bg: "rgba(61, 143, 160, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
- **Fonts** — already set to **Geist** (display) / **Geist** (body); ignore any preset font name lingering in prose.
